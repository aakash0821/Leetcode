...
<p style="user-select: auto;">Find the names of the customer that are <strong style="user-select: auto;">not referred by</strong> the customer with <code style="user-select: auto;">id = 2</code>.</p>
